...
HD_PWD='C:/Users/Carina/workspace/project_2/project_2.runs/Base_Zynq_MPSoC_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Zynq_MPSoC_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Base_Zynq_MPSoC_auto_pc_0.tcl

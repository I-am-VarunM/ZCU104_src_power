...
double max(double values[], int length){
	return max_of_window(values, length, length);
}

double min(double values[], int length){
	return min_of_window(values, length, length);
}

double min_max_diff(double values[], int length){
	double min_val = min(values, length);
	double max_val = max(values, length);
...
double min_max_diff_of_window(double values[], int length,int window){
	double min_val = min_of_window(values, length,window);
	double max_val = max_of_window(values, length,window);
	double diff = max_val - min_val;
	return diff;
}
...
double spkt_welch_density(double values[], int length, int coef) {
	...
	printf("Welch buff has %i elements of size %lu, total size %lu\n", number_overlaps*nperseg+length,sizeof(double), (number_overlaps*nperseg+length)*sizeof(double));
	...
	//printf("window temp\n");
    printf("Welch buff has %i elements of size %lu, total size %lu\n", number_overlaps*nperseg+length+1+256+length,sizeof(double), (number_overlaps*nperseg+length+1+256+length)*sizeof(double));
	...
	free(temp);
    //printf("Welch buff has %i elements of size %lu, total size %lu\n", number_overlaps*nperseg+256,sizeof(double), (number_overlaps*nperseg+256)*sizeof(double));
	//printf("free\n");
   ...
   // printf("Welch buff has %i elements of size %lu, total size %lu\n", number_overlaps*nperseg,sizeof(double), (number_overlaps*nperseg)*sizeof(double));
    ...
    //printf("size of double complex %lu \n", sizeof(double complex));
    printf("Welch buff has %i elements of size %lu, total size %lu\n", 2*number_overlaps*nperseg+length+1+256+length,sizeof(double complex), (number_overlaps*nperseg)*sizeof(double complex)+(number_overlaps*nperseg+length+1+256+length)*sizeof(double));

    //printf("Welch buff has %i elements of size %lu, total size %lu\n", 2*number_overlaps*nperseg,sizeof(double), (2*number_overlaps*nperseg)*sizeof(double));
    ...
    printf("Welch buff has %i elements of size %lu, total size %lu\n", 3*number_overlaps*nperseg+length+1+256+length,sizeof(double complex), (2*number_overlaps*nperseg)*sizeof(double complex)+(number_overlaps*nperseg+length+1+256+length)*sizeof(double));

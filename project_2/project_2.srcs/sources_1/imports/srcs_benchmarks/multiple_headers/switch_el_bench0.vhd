...
entity switch_elements0 is
   -- generic ( amount : integer := 16 );
    ...
    attribute dont_touch of switch_elements0 : entity is "true";
    
  
    
end switch_elements0;

architecture avaz of switch_elements0 is
component ava is
	port
	(
...
begin
    ...
    sync_iu    <= unsigned(enable_s(31 downto 0));
    
    vec16_in(0) <= unsigned(enable_s(15 downto 0));
    vec16_in(1) <= unsigned(enable_s(31 downto 16));
    vec16_in(2) <= unsigned(enable_s(15 downto 0));
    vec16_in(3) <= unsigned(enable_s(31 downto 16));
    vec16_in(4) <= unsigned(enable_s(15 downto 0));
    vec16_in(5) <= unsigned(enable_s(31 downto 16));
    vec16_in(6) <= unsigned(enable_s(15 downto 0));
    vec16_in(7) <= unsigned(enable_s(31 downto 16));

...
proc create_root_design { parentCell } {
  ...
  # Create instance: Measurement_Load_1, and set properties
  set block_name Measurement_Load
  set block_cell_name Measurement_Load_1
  if { [catch {set Measurement_Load_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Measurement_Load_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.NUM_OF_MODULES {15000} \
 ] $Measurement_Load_1
  ...
  if { [catch {set Simulated_Load_IP_Co_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.SIZE_PER_FINE_MODULE {100} \
  ...
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins Measurement_Load_1/en] [get_bd_pins axi_gpio_2/gpio2_io_o]
